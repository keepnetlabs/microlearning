      ...
      <AnimatePresence>
        {isHovered && !showEditor && (
          <motion.div
            ...
            className="w-6 h-6 glass-border-4 text-[#1C1C1E] dark:text-[#F2F2F7] rounded flex items-center justify-center z-50 transition-all hover:scale-110 flex-shrink-0 cursor-pointer"
      ...
      {showEditor && createPortal(
        <AnimatePresence>
          <div className="fixed inset-0 z-[9999] flex items-center justify-center">
            ...
            <div className="flex items-center justify-end gap-2 mt-4 pt-3 border-t border-white/20 dark:border-white/10">
              <button
                onClick={handleCancel}
                className="px-3 py-1.5 text-sm glass-border-4 text-[#1C1C1E] dark:text-[#F2F2F7] hover:scale-105 transition-all"
              >
                Cancel
              </button>
              <button
                onClick={handleSave}
                className="px-3 py-1.5 text-sm glass-border-3 text-[#1C1C1E] dark:text-[#F2F2F7] flex items-center gap-1 transition-all hover:scale-105 bg-blue-500/10"
              >
                <Save size={12} />
                Save
              </button>
