...
export function ProgressBar({ currentScene, totalScenes }: ProgressBarProps) {
  ...
  return (
    <div className="w-full font-['Open_Sans']" role="progressbar" aria-valuenow={progress} aria-valuemin={0} aria-valuemax={100} aria-label={`Eğitim ilerlemesi: %${Math.round(progress)} tamamlandı`}>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-100/20 via-slate-200/12 to-slate-300/8 dark:from-slate-700/18 dark:via-slate-600/12 dark:to-slate-500/8 rounded-full transition-colors duration-500"></div>
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    border: isCompleted
                      ...
                      : isActive
                      ? '0.5px solid rgba(59, 130, 246, 0.60)'
                      : '0.5px solid rgba(148, 163, 184, 0.40)',
      ...
      >
        ...
        >
          <span className="relative z-10 font-medium text-gray-600 dark:text-gray-400">Başlangıç</span>
        ...
        >
          <span className="relative z-10 font-semibold text-blue-700 dark:text-blue-300">
        ...
        >
          <span className="relative z-10 font-medium text-gray-600 dark:text-gray-400">Tamamlandı</span>
